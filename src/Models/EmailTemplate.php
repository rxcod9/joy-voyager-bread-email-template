...
namespace Joy\VoyagerBreadEmailTemplate\Models;
...
use Joy\VoyagerBreadEmailTemplate\Database\Factories\EmailTemplateFactory;
...
class EmailTemplate extends Model
{
    ...
    {
        return $this->belongsTo(Voyager::modelClass('EmailTemplate'));
    }
